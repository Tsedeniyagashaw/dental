...
const BookAppointment = () => {
  ...
  return (
    <div
      id="book"
      className="scroll-mt-20 min-h-screen bg-linear-to-br form-sky-50 to-sky-50 py-12 px-4"
    >
      <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            <div
              className="absolute top-1/2 left-0 right-0 h-2
                    bg-gray-100 rounded-full z-0"
            ></div>
            <div
              className="absolute top-1/2 left-0  h-2 bg-linear-to-r form-sky-400 to-sky-400 rounded-full z-10 transition-all duration-500"
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden ">
          ...
          {activeStep == 2 && (
            <div className="p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                <FaCalendarAlt className="mr-3 text-sky-500" /> Appointment
                Details
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative">
                  ...
                  />
                  <FaCalendarAlt
                    className="absolute left-4 top-1/2 transform -traslate-y-1/2 text-gray-400
                        "
                  />
                </div>
