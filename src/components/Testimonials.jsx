  ...
  const testimonials = [
    {
      ...
      role: "patient",
      content:
        "The clinic staff are very friendly and professional. Highly recommend!",
      rating: 5,
      image: "/test4.jpg",
    },
    {
      ...
      role: "patient",
      content:
        "Had a great experience with my dental cleaning. Very comfortable and painless.",
      rating: 4,
      image: "/test1.jfif",
    },
    {
      ...
      role: "patient",
      content:
        "The dentist explained everything clearly. My teeth feel amazing!",
      rating: 5,
      image: "/test3.jfif",
    },
    {
      ...
      role: "patient",
      content:
        "Friendly staff and excellent service. Will definitely come back for future checkups.",
      rating: 4,
      image: "/test2.jfif",
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-600">
            ...
            clinic. Friendly care and healthy smiles guaranteed!
          </p>
        </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center">
                  <div className="md:w-1/3 mb-8 md:mb-0 flex justify-center">
                    <div className="relative">
                      ...
                      />
                      <div
                        className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-skt-500
