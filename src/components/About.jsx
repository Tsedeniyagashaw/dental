      ...
      >
        ...
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left px-8">
          ...
          <p className="text-gray-700 text-md leading-relaxed">
            ...
            dental care in a warm and welcoming environment. Our experienced
            team of dental professionals utilizes the latest technology and
            techniques to ensure that each patient receives personalized
            treatment tailored to their unique needs.
          </p>
          <p className="text-gray-700 text-md leading-relaxed">
            From routine check-ups and cleanings to advanced restorative and
            cosmetic procedures, we prioritize your oral health and overall
            well-being. Your comfort and satisfaction are our top priorities,
