...
const Hero = () => {
  return (
    <section id="home" className="scroll-m-20 bg-sky-50 py-16 px-1 lg:px-20">
      <div
        className="container mx-auto px-20 flex flex-col-reverse
      ...
      >
        <div className="max-w-xl text-center lg:text-left space-y-6 ">
          ...
          <p className="text-gray-700 text-sm lg:text-lg">
            Experience top-notch dental care with our expert team. From routine
            check-ups to advanced treatments, we are dedicated to your oral
        ...
        <div className="flex justify-center">
          <img
            src={hero}
            alt="Dental"
            className="w-80 lg:w-[499px] rounded-4xl"
          />
        </div>
      </div>
    </section>
