...
const contactInfo = [
  ...
  },
  {
    ...
    text: <span>123 Dental Avenue, Health District</span>,
  },
];
        ...
        <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-sky-300 transition-colors">
          ...
          <div className="flex w-full">
            <input
              ...
              className="bg-white/10 border border-white/20 text-white px-5 py-3 rounded-l-lg rounded-r-none focus:outline-none focus:ring-2 focus:ring-sky-300 w-full placeholder-white/50"
            />
            <button className="bg-sky-500 hover:bg-sky-400 text-blue-900 font-medium px-5 py-3 rounded-r-lg rounded-l-none transition-colors flex items-center">
              Subscribe
            </button>
          </div>
        </div>
